...
export default function Home() {
  ...
  // TechTag Component (add this component)
  ...
  return (
    <div className="bg-[rgba(6,15,11,1)] flex justify-center overflow-y-auto">
      <div className="w-[90%] h-[100vh] text-white flex-col justify-center">
        ...
        <div className="w-[60%] h-full mx-auto mt-[20px] py-10 font-bold">
